...
const int Rin = 12, Lin = 10, Rout = 13, Lout = 11, serv = 9;  //setting sensor pins and servo pin
...
void loop() {
  ...
  // Give a short LOW pulse beforehand to ensure a clean HIGH pefdasulse:
  pinMode(Rout, OUTPUT);
